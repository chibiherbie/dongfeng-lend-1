<template>
  <section id="service" class="body-font bg-[#ECECEC] relative w-full pb-40 text-black">
    ...
    <div class="flex relative h-[140px] w-full mb-32">
    ...
    <div class="w-full relative">
        ...
        <Carousel ref="carousel" v-model="currentSlide" :items-to-show="2.5" :wrap-around="true">
          <Slide v-for="slide in cars_data.cars" :key="slide">
            <div class="md:w-full xl:w-[90%]">
              ...
              <img :src="'img/' + slide.img + '.png'" alt="Изображение" class="h-32 w-60 md:h-auto md:w-auto">
      ...
      <button type="button" class="absolute right-[28%] xl:right-[33%] bottom-32 xl:bottom-52 z-10" @click="next">
      ...
      <button type="button" class="absolute left-[28%] xl:left-[33%] bottom-32 xl:bottom-52 z-10" @click="prev">
