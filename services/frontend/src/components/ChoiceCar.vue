<template>
  <section id="service" class="body-font bg-[#ECECEC] relative w-full pb-20 md:pb-10 text-black pt-4 md:pt-24">
    ...
    <div class="flex relative h-[92px] md:h-[140px] w-full mb-16 md:mb-20">
    ...
    <div class="w-full relative">
        ...
        <Carousel ref="carousel" v-model="currentSlide" :items-to-show="itemsToShow" :wrap-around="true">
          <Slide v-for="slide in cars_data.cars" :key="slide">
            <div class="md:w-full">
              ...
              <div class="md:w-full px-5 py-10 mx-auto bg-white rounded-3xl md:rounded-[98px] relative">
      ...
      <button type="button" class="absolute right-1 sm:right-20 md:right-[30%] xl:right-[33%] bottom-32 xl:bottom-52 z-10" @click="next">
      ...
      <button type="button" class="absolute left-1 sm:left-20 md:left-[30%] xl:left-[33%] bottom-32 xl:bottom-52 z-10" @click="prev">
  ...
  computed: {
    ...
    itemsToShow() {
      if (window.innerWidth < 768) {
        ...
        return 3; // На больших экранах отображаем 2.5 элемента
      }
    }
  },
  methods: {
